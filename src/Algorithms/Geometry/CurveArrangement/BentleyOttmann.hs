als je dat van plan bent denk ik dat je het beste de 'LineSegment 2 p r's kunt vervangen 
door een arbitrare 's' met typeclass. En vanuit daar kijken wat je verder aan moet passen 
zou zoiets moeten zijn als: gegeven twee 's''en, en een hoogte (y-waarde) geef me de volgende 
event 
en geef me de eindpunten
en test of een gegeven punt links/rechts van de curve ligt ofzo

horizontale sweepline
...
--
--------------------------------------------------------------------------------
module Algorithms.Geometry.CurveArrangement.BentleyOttmann where

import           Algorithms.Geometry.CurveArrangement.Types
